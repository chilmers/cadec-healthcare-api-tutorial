...
Task 2 -------------
  ...
  The parameters are also described in detail at the SDK site, section 1 (Dirigera om användaren till auktorisations-dialogen i Mina vårdkontakter) on this page: http://sdk.minavardkontakter.se/sv/sdk-api/svenska-anvisningar-for-uppkopling-till-patientdata-apierna/

  You can now test to click the link and login to the authorization dialog using BankID and the test certificates, http://sdk.minavardkontakter.se/wp-content/uploads/2012/04/Test-E-leg.zip 
...
Task 3 -----------
Handle the response from the authorization dialog and collect an access token.
...
Task 4 ---------- 
Use access token to fetch the user's schedule
