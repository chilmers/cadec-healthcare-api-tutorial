...
------------- Task 1:
Fetch public data from the HSA API to get information about a healthcare facility
...
Foot note, SE2321000016-10S5 is the HSA-id of a dentist at Lidingö.
...
Hint: Request headers are set with the -H flag in curl, e.g. -H"[header name]: [header value]"
Hint 2: We want to set thh header named Accept
